package br.com.itau.awskms.examples;
...
//        final String keyArn = args[0];
        final String keyArn = "arn:aws:kms:sa-east-1:414891437435:key/28b06332-b0ba-4527-8a41-f414ba50ee5d";
    ...
    static void encryptAndDecrypt(final String keyArn) {
        ...
        boolean equals = Arrays.equals(decryptResult.getResult(), EXAMPLE_DATA);
